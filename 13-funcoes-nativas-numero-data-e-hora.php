...
<head>
    ...
    <title>Funçoes nativas</title>
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.8/dist/css/bootstrap.min.css" rel="stylesheet" integrity="sha384-sRIl4kxILFvY47J16cr9ZwB07vP4J8+LH7qKQnuqkuIAvNWLzeN8tE5YBujZqJLB" crossorigin="anonymous">
</head>
<body>
    <div class= "container">
    <h1>Funçoes nativas: números, data e hora</h1>
    <hr>
    <h2>Números</h2>
    <h3>max</h3>
    <p>Maior valor na lista comparable passada:
...
<p>Número com ajuste de casas decimais:
    ...
    <?php 
    date_default_timezone_set("America/Sao_Paulo"); //mostrar a hora certa do brasil
    $data =("d/m/y");
    $hora = date ("H:i:s");
    ...
    //Usamos o strotime para converter primeiro a data em um timestamp( data em formato numérico). Em seguida, o date aplica o formato desejado.*/
