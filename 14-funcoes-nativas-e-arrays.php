...
// Isso evita conflito/sobreescrita de outras vaiáveis.
?>
<ul>
    <li>ID: <?= $chave_id ?></li>
...
//podemos combinar funçoes de array (abaixo, merge e depois unique)
...
<hr>
<h2>array_combine()</h2>
<p>Cria um novo array a partir de uma lisyta de valores e uma lista de chaves.</p>
...
<?php 
$catalogoComDesconto = array_map (function( float $precos): float{
